...
export const classifyQuotaError = lib.classifyQuotaError;
export const isQuotaPauseActive = lib.isQuotaPauseActive;
export const QUOTA_PAUSE_COOLDOWN_MS = lib.QUOTA_PAUSE_COOLDOWN_MS;
