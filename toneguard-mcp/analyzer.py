...
class ToneAnalyzer:
    ...
    def _build_synthesizer_prompt(
        ...
        return (
            ...
            "   - **brevity**: Minimum words to convey the point. Apply Smart Brevity "
            "word-level rules to EVERY rewrite regardless of length: muscular lead ≤12 "
            "words, no foggy verbs (could/may/might), no filler (very/really/just/"
            "basically/actually/somewhat), active voice always, one-syllable words over "
            "multi-syllable when meaning is preserved. For long-form rewrites (40+ words "
            "OR 3+ sentences), ALSO apply structural Smart Brevity: one-screen ceiling, "
            "why-it-matters as a distinct beat after the lead, bullets over blobs for "
            "parallel points. When picking between competing rewrites, prefer the one "
            "that better satisfies Smart Brevity\n"
